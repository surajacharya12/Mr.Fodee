        ...
        <div className="max-w-md w-full mx-4 bg-white rounded-[3rem] p-10 shadow-xl border border-gray-100 text-center">
          {loading ? (
            <div className="space-y-6">
              ...
              <h2 className="text-2xl font-black text-[#2D2D2D]">Verifying Payment...</h2>
              <p className="text-gray-400 font-bold">Please wait while we confirm your transaction.</p>
            </div>
          ) : status === "success" ? (
            <div className="space-y-8">
              ...
              <div>
                <h2 className="text-4xl font-black text-[#2D2D2D] mb-4">Payment Success!</h2>
                <p className="text-gray-400 font-bold text-lg leading-relaxed">
                  Your payment has been verified. Your order is now <span className="text-[#EE4444]">Confirmed</span>.
                </p>
              </div>
